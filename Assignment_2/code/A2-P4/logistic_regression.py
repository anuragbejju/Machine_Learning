...
#  Assignment 5 (Question 4 - Logistic_Regression.py)
...
#plt.savefig('Logistic_Regression_slope_intercept.png', dpi=1000, bbox_inches='tight', pad_inches=0.3)
...
plt.legend(["eta : 0.5"])
plt.show()
#plt.savefig('Logistic_Regression.png', dpi=1000, bbox_inches='tight', pad_inches=0.3)
